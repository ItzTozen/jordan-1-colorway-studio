...
// Ghost word is sized per colorway so long names still fit the stage.
      ...
      <div className="hero-grid">
        <div className="copy">
          ...
          <div className="cta r" style={{ '--d': '.65s' }}>
            ...
            <a className="btn btn-ghost" href="#collection">Explore Colorways</a>
          </div>
        ...
        <div className="stage r" style={{ '--d': '.3s' }}>
          <span className="stage-count" aria-hidden="true">
            0{idx + 1}<i>/0{COLORWAYS.length}</i>
          </span>
